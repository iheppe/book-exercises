...
salary_values <- c(runif(100, 40000, 50000))
...
salaries <- data.frame(employees, salary_values, salary_adjustments)

# Add a column to the `salaries` data frame that represents each person's
# salary in 2018 (e.g., with the salary adjustment added in).
salaries$salary_total <- salary_values + salary_adjustments
...
# Yes - they are very close to the middle of their respective bounds
